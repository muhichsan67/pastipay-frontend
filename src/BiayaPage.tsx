...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: "Kapan dana hasil transaksi dicairkan ke rekening saya?",
    answer:
      "Dana dicairkan otomatis setiap hari kerja (H+1) ke rekening bank yang terdaftar, tanpa perlu pengajuan manual.",
  },
  {
    question: "Apakah PastiPay aman digunakan untuk bisnis saya?",
    answer:
      "Ya. PastiPay berizin dan diawasi oleh Bank Indonesia serta memenuhi standar keamanan PCI DSS untuk melindungi setiap transaksi.",
  },
  {
    question: "Apakah ada biaya pendaftaran atau biaya bulanan?",
    answer:
      "Tidak ada biaya pendaftaran maupun biaya bulanan. Anda hanya membayar per transaksi sukses.",
  },
  {
    question: "Pembayarannya bisa melalui apa saja?",
    answer:
      "Kami dapat melalui QRIS dan semua bank yang di awasi OJK yang ada di Indonesia.",
  },
];
    ...
    <div className="bp-page">
      ...
      <header className="bp-navbar">
        <div className="bp-navbar-inner">
          <a href="/" className="bp-logo">
            <span className="bp-logo-mark" aria-hidden="true">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none">
                <path
                  d="M3 10.5 12 4l9 6.5M5 9.5V19h14V9.5M9 19v-6h6v6"
                  stroke="#ffffff"
                  strokeWidth="1.8"
                  strokeLinecap="round"
          ...
          <nav className="bp-nav-links">
            <a href="/">Beranda</a>
            <a href="/biaya" className="bp-nav-active">
              Biaya
            </a>
          ...
          <div className="bp-nav-actions">
            <a href="/masuk" className="bp-link-muted">
              Masuk
            </a>
            <a href="/daftar" className="bp-btn bp-btn-primary">
              Daftar Sekarang
            </a>
          </div>
        </div>
      ...
      <footer className="bp-footer">
        <div className="bp-footer-inner">
          <div>
            <h3 className="bp-footer-brand">PastiPay</h3>
            <p className="bp-footer-desc">
              Penyedia gerbang pembayaran terpercaya dengan standar keamanan
          ...
          <div>
            <h4>Legalitas</h4>
            <div className="bp-legal-badges">
              <span className="bp-tag">Berizin OJK</span>
              <span className="bp-tag">PCI DSS</span>
            </div>
          </div>
        </div>
        <div className="bp-footer-bottom">
          © 2026 PastiPay. Secure Financial Certainty.
        </div>
      </footer>
    </div>
  );
